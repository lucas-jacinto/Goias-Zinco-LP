   ...
   <section className="info">
    <div className='detalhe_top'>
      ...
      <div className="container info_container">
        <SectionHead icon={<FaCrown/>} title="Nossos Produtos" className='nossos_produtos'/>
        <div className='info_wrapper'>
          {
            info.map(({id, icon, title, path, infos})=>{
              return (
                <Card className="info_cards" key={id}>
                    <span>{icon}</span>
                    <h4>{title}</h4>
                    <small>{infos}</small>
                    <Link to={path} className="btn sm">Ver Mais &nbsp;<AiFillCaretRight /></Link>
                </Card>
              )
            })
          }
